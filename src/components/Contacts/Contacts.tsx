...
export const Contacts = () => {
  const { isVisible, changeVisibility } = useContactsStore();
  return (
    <Modal visible={isVisible} setVisible={changeVisibility}>
      <div className="w-[768px] relative font-bold text-contactColor flex flex-col items-center h-[570px] bg-white rounded-[66px] ">
        ...
        <div className="flex items-center justify-center w-[696px] text-[38px] rounded-[30px] px-[110px] bg-cardProductComposition py-[33px]">
          <svg
            className="mr-[22px]"
            width="66"
            height="67"
        ...
        <div className="flex items-center justify-center w-[696px]  text-[38px] rounded-[30px] px-[130px] bg-cardProductComposition mt-[22px] py-[33px] ">
          <svg
            className="mr-[22px]"
            width="66"
            height="67"
          ...
          >
            <g clipPath="url(#clip0_825_4078)">
              ...
              />
              <path
                d="M8.25 19.6709L33 36.1709L57.75 19.6709"
                stroke="#434343"
                strokeWidth="4.17311"
                strokeLinecap="round"
                strokeLinejoin="round"
