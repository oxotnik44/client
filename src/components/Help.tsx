  ...
  return (
    <>
      ...
      <Modal setVisible={setVisible} visible={visible}>
        <div className="px-[70px] flex flex-col relative gap-[66px] pt-[92px] text-textGrey w-[788px] bg-white h-[706px] rounded-[66px] ">
          <div className="flex  justify-start  items-start h-[72px] ">
            <img src={first} alt={"first"} />
            <div className="pl-[32px] font-bold w-[65%] text-[28px] text-start ">
              Выберите раздел меню <br /> по вашему желанию
            </div>
          </div>
          <div className="flex  justify-start items-start h-[72px] ">
            <img src={second} alt={"second"} />
            <div className="pl-[32px] font-bold w-[100%] text-[28px] text-start ">
              Двигайте меню скроллом <br />и выберете желаемый продукт
            </div>
          </div>
          <div className="flex  justify-start items-start h-[108px] ">
            <img src={third} alt={"third"} />
            <div className="pl-[32px] font-bold w-[100%] text-[28px] text-start ">
              Нажмите "Приготовить" чтобы получить свой свежий только
